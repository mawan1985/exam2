export default function page() {
    return (
      <>
      <h1 className="text-3xl ml-5 text-white">Final Exam</h1>  
      <form>
        <label htmlFor="product" className="ml-5 text-white">Student Name</label>
        <input type="text" name="product" id="product" className="m-5 text-white bg-orange-400"/>
        <br />
        <label htmlFor="product" className="ml-5 text-white">Course Description</label>
        <input type="text" name="product" id="product" className="m-5 text-white bg-orange-400"/>
        <br />
        ...
        <h1 className="text-1xl mx-5 text-white">Choose your Schedule</h1> 
        ...
        <br />
        <div className="ml-5 mt-5"> 
        <h1 className="text-1xl mx-5 text-white">Programs!!!</h1> 
